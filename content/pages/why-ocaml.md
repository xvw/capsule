...
Il existe probablement d'autres ressources et témoignages, notamment
...
Je pense qu'il y a deux axes de réponse. Le premier, et le plus
...
servent pas encore d'outils de _design_ expressifs.
...
- **La performance.** L'ajout de plomberie peut engendrer des coûts,
...
- L'ensemble des paradigmes et des fonctionnalités du langage sont
...
- Des **types produits** : qui permettent de grouper des valeurs de
...
> Attention, dans mon exemple, j'utilise une syntaxe expérimentale,
...
- Un langage _confortable pour la programmation fonctionnelle_,
...
C'est pour ça que les fonctionnalités offertes par le langage ne sont
...
Je dois avouer qu'en venant d'une ère où OPAM n'existait pas, j'ai
...
- adossé à [dune-release](https://github.com/tarides/dune-release), il
...
Tous ces sujets impliquent tout de même la nécéssité d'un bon
...
En plus de ces bibliothèques standards alternatives, on trouve des
...
- **Très bienveillante** : il m'arrive souvent d'avoir à demander de
...
> Pourquoi continuer à faire du OCaml, quand on peut disposer du même
...
module expose aussi le type de module `S`. L'effet de bord bénéfique
de ce _leak_ est que l'on peut facilement référencer la signature du
module en utilisant `My_mod.S` plutôt que de devoir utiliser `module
type of My_mod`.
...
Je trouve que cette séparation est **très désirable**, cependant, le
...
_expressivité_ parce que le contre-coup de ce regroupement est la
perte de la compilation séparée, ce que je trouve sacrément balot.


## Pour conclure


Je pense avoir _sommairement_ survolé les points que je voulais
développer. De mon point de vue, **OCaml est un langage génial** ! En
...
langage de modules riche, des objets, le support de _row polymorphism_
...
les éceuils d'une intégration trop rapide et non éprouvée.


Même si pendant plusieurs années, l'outillage de OCaml pouvait sembler
un peu ... _poussiéreux_, ces derniers temps, notamment grâce au
support commercial de certaines entreprises, l'outillage s'est
drastiquement modernisé, et continue son progrès comme le témoigne [la
feuille de route de la
plateforme](https://ocaml.org/tools/platform-roadmap). En complément,
...
En ajoutant à un langage expressif, doté d'un écosystème versatile,
...
amusés par les langages de programmation, **je vous invite
sérieusement à considérer OCaml** !


J'espère avoir réussi à transmettre mon intérêt pour ce langage (et
...
alors vous pouvez vous adresser à la communauté par le biais [du
forum](https://discuss.ocaml.org/) qui est actif, réactif et
bienveillant !
